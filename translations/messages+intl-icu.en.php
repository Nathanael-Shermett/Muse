...
$messages = [
	...
	'post.new.abstract.constraint.length.max' => 'Your abstract must be { limit } characters or less.',
	'post.new.abstract.constraint.length.min' => 'Abstracts are optional. However, if you wish to provide one, please make it more thorough.',
	'post.new.abstract.placeholder' => 'Abstract (optional; 150 characters or less)',
	'post.new.categories.constraint.length.max' => 'You may not select more than two categories.',
	'post.new.categories.constraint.length.min' => 'Please select at least one category (but not more than two).',
	'post.new.categories.placeholder' => 'Categories (2 max)',
	'post.new.content.constraint.length.min' => 'Your post must be at least { limit } characters long.',
